  ...
  const onSubmit = (values: FormValues) => {
    if (!values.title || values.title.trim().length < 3) {
      toast({
        ...
        description: "Provide a descriptive title (min 3 chars).",
      });
      return;
    }
    ...
    toast({
      title: `${values.type === "lost" ? "Lost" : "Found"} item posted`,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        <div className="mb-6 flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Post lost or found items and connect with your community.
            </p>
          </div>
        </div>
        ...
        <Tabs
          ...
          onValueChange={(v) => {
            ...
            form.setValue("type", v as ItemType);
          }}
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <TabsContent
              value="lost"
              className="lg:col-span-2 [&[data-state=inactive]]:hidden"
            >
              <Card>
                <CardHeader>
                  <CardTitle>Post a Lost Item</CardTitle>
                  <CardDescription>
                    Provide details to help others identify and return your
                    item.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input
                                  placeholder="e.g. Black wallet with initials RG"
                                  {...field}
                                />
                              </FormControl>
                              <FormMessage />
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Textarea
                                rows={5}
                                placeholder="Describe the item, distinctive marks, when and where it was lost."
                                {...field}
                              />
                            </FormControl>
                            <FormMessage />
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                placeholder="e.g. Near North Gate, IETK campus"
                                {...field}
                              />
                            </FormControl>
                            <FormMessage />
                          ...
                          render={({ field }) => (
                            <FormItem className="flex items-center justify-between rounded-lg border p-3">
                              <div className="space-y-0.5">
                                ...
                                <FormDescription>
                                  Share your info so finders can reach you.
                                </FormDescription>
                              </div>
                              <FormControl>
                                <Switch
            ...
            >
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Help reunite items with their owners by sharing details.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Form {...form}>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input
                                  placeholder="e.g. Silver ring with blue stone"
                                  {...field}
                                />
                              </FormControl>
                              <FormMessage />
                          ...
                          render={({ field }) => (
                            <FormItem className="flex items-center justify-between rounded-lg border p-3">
                              <div className="space-y-0.5">
                                <FormLabel>Allow contact</FormLabel>
                                <FormDescription>
                                  Share your info so owners can reach you.
                                </FormDescription>
                              </div>
                              <FormControl>
                                <Switch
                      ...
                      >
                        <div className="flex items-start justify-between gap-3">
                          ...
                          <div className="flex items-center gap-2">
                            <Select
                              onValueChange={(v) =>
                                markStatus(it.id, v as ItemStatus)
                              }
                            >
                        ...
                        {it.contact?.allowContact &&
                          (it.contact.email || it.contact.phone) && (
